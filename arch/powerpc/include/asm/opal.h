...
int64_t opal_npu_destroy_context(uint64_t phb_id, uint64_t id);
int64_t opal_npu_init_context(uint64_t phb_id, int pasid, uint64_t msr, uint64_t lpid);
int64_t opal_npu_map_lpar(uint64_t phb_id, uint64_t bdf, uint64_t lparid, uint64_t lpcr);
